...
const translations = {
  ka: {
    ...
    subtitle:
      "ჩვენ ვიყენებთ ტაქსებს, როგორც მოძრავ რეკლამის პლატფორმას. ციფრული ეკრანები ტაქსების თავზე - თქვენი ბრენდის ხილვადობა მთელ ქალაქში.",
    cta: "დაიწყეთ პროექტი",
  ...
  en: {
    ...
    subtitle:
      "We use taxis as moving advertising platforms. Digital displays on taxi rooftops - your brand visibility across the entire city.",
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-purple-400/10 to-pink-400/10 rounded-full blur-3xl animate-float"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Badge */}
          <div
            className={`inline-flex items-center space-x-2 bg-gradient-to-r from-[#75604B]/10 to-[#8B7355]/10 text-[#75604B] px-6 py-3 rounded-full text-sm font-medium mb-8 backdrop-blur-sm border border-[#75604B]/20 hover:scale-105 transition-all duration-300 cursor-pointer ${
          ...
          {/* Main Title */}
          <h1
            className={`text-4xl sm:text-5xl lg:text-7xl font-bold bg-gradient-to-r from-gray-900 via-[#75604B] to-gray-900 bg-clip-text text-transparent mb-6 leading-tight ${
          ...
          <div
            className={`flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 ${
              isVisible ? "animate-slide-up animate-stagger-3" : "opacity-0"
            }`}
          >
            <button
          ...
          >
            <div className="group bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/80 hover:shadow-lg transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">
                {language === "ka" ? "მაღალი ROI" : "High ROI"}
              </h3>
            ...
            <div className="group bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/80 hover:shadow-lg transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">
                {language === "ka" ? "ციფრული ეკრანები" : "Digital Displays"}
              </h3>
              <p className="text-sm text-gray-600">
                {language === "ka" ? "HD ხარისხი" : "HD Quality"}
              </p>
            </div>
          </div>
